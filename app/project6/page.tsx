    ...
    <div>
        ...
        <div className="bg-primary4 flex flex-col items-center">
            ...
            <div className=' 2xl:w-[1200px] w-full 2xl:px-20 xl:px-36 lg:px-32 md:px-24 px-4 pt-40 h-full'>
                <h1 className='text-center 2xl:text-[37px] text-[28px] pb-10 font-anton text-primary1'>Toyota Andon Visualization</h1>
                        ...
                        <CarouselContent className='h-50'>
                            { Array.from({ length: 13 }, (_, i) => i + 1).map((number, index)=>(
                                <CarouselItem key={index}>
                                    ...
                                    <Image src={`/img/project6/project-6-${index+1}.png`} alt={`project6-${index+1}`} height={800} width={1600} className=''/>
                                    </div>
                                </CarouselItem>
                ...
                <section className='pt-20'>
                    ...
                    <div>
                        <ul className='list-disc px-4 2xl:text-[20px] md:text-[27px] text-[17px]'>
                            <li>Dashboard management for materials</li>
                            <li>Login and token session for authentication</li>
                            <li>Real-time countdown for monitoring material consumption</li>
