    ...
    <div>
        ...
        <div className="bg-primary4 flex flex-col items-center">
            ...
            <div className='2xl:w-[1200px] w-full h-full bg-primary4 2xl:px-20 xl:px-36 lg:px-32 md:px-24 px-4 py-40 pb-0'>
                <h1 className='text-center text-[37px] pb-10 font-anton text-primary1'>KKN</h1>
                <div className='flex justify-center w-full  bg-primary2 p-0 rounded-xl duration-[3000ms]'>
                    <Carousel prevArrow={({ handlePrev }) => (
                        ...
                        <Image width={1920} height={1080} src="/img/project-2.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-1.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-2.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-3.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-4.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-5.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-6.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-7.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-8.png" alt="" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/project2/project-2-9.png" alt="" className="h-full w-full object-cover"/>
                    </Carousel>
                </div>
