    ...
    <div>
        ...
        <div className="bg-primary1 flex flex-col items-center">
            ...
            <div className=' 2xl:w-[1200px] w-full 2xl:px-20 xl:px-36 lg:px-32 md:px-24 px-4 pt-40 h-full'>
                <h1 className='text-center text-[37px] pb-10 font-anton text-primary4'>Suitmedia</h1>
                <div className='flex justify-center w-full  bg-primary2 p-0 rounded-xl duration-[3000ms]'>
                    <Carousel  prevArrow={({ handlePrev }) => (
                        ...
                        <Image width={1920} height={1080} src="/img/slicing1/slicing-1-1.png" alt="slicing1-1" className="h-full w-full object-cover"/>
                        <Image width={1920} height={1080} src="/img/slicing1/slicing-1-2.png" alt="slicing1-2" className="h-full w-full object-cover"/>
                    </Carousel>
                </div>
                ...
                <section className='pt-20'>
                    ...
                    <div className="text-primary4 pb-20">
                        <ul className='list-disc px-4 2xl:text-[20px] md:text-[27px] text-[17px]'>
                            <li>Repository: <a href='https://github.com/danurrizad/project-test-danurrizad' className='hover:underline'>https://github.com/danurrizad/project-test-danurrizad</a></li>
                            <li>Live web : <a href='https://danurrizad-slicing-suitmedia.netlify.app/' className='hover:underline'>https://danurrizad-slicing-suitmedia.netlify.app/</a></li>
                        </ul>
                    </div>
                </section>
            </div>
