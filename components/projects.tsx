                    ...
                    <SlideInAnimation index={index}>
                        <div id={`project${index+1}`} className="2xl:px-20 ">
                            <div className="relative  rounded-2xl">
                                <Image src={`/img/project-${index+1}-cover.png`} alt={`project${index+1}-cover`} height={1080} width={1920} className='shadow-md shadow-black rounded-2xl 2xl:rounded-b-2xl rounded-b-none'/>
                                ...
                                <div className='bg-white 2xl:h-20 h-12 2xl:bg-opacity-25 backdrop-blur-xl z-30 absolute 2xl:bottom-0 w-full flex justify-center  items-center rounded-b-2xl 2xl:shadow-none shadow-md shadow-black'>
                                    <a href={`/project${index+1}`} className='button 2xl:w-fit w-full 2xl:h-fit h-full text-center 2xl:text-[20px] xl:text-[18px] lg:text-[16px] text-[12px] md:text-[28px]  text-primary1 px-10 2xl:py-2 py-0 rounded-2xl 2xl:rounded-t-2xl rounded-t-none'>
                                        Project Details
                                    </a>
                                </div>
