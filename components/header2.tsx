...
const Header = () => {
  ...
  return (
    ...
    <div className='fixed z-50 w-screen bg-primary2 flex justify-center shadow-sm shadow-black'>
        <div className='flex w-[1200px] items-center justify-between 2xl:text-[24px] xl:text-[22px] lg:text-[20px] md:text-[18px] 2xl:px-20 xl:px-20 lg:px-20 md:px-20 px-4 2xl:py-5 xl:py-4 py-3 bg-primary2 text-white font-anton'>
            <div className=''>
