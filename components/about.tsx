    ...
    <div id='about' className='min-h-screen bg-primary1 2xl:px-40 xl:px-36 lg:px-32 md:px-32 px-4 pt-40'>
        ...
        <div className='text-primary4 flex 2xl:flex-row xl:flex-row lg:flex-row flex-col items-center justify-between gap-0'>
                <div className='w-auto '>
                    <SlideInFromLeft>
                    <div className="2xl:w-4/6 xl:w-4/6 lg:w-4/6 w-4/6 ">
                      <Image
                        loading='lazy'
                        src="/img/profile-picture-1.png"
                        alt="Description of the image"
                        width={1400} // Equivalent to 'w-4/6' in Tailwind
                        height={100}  // Set an appropriate height
                      />
                    </div>
                        {/* <Image layout="responsive"  className='2xl:w-full xl:w-full lg:w-full w-4/6' src="/img/profile-picture-bw.png" alt='profile-picture'/> */}
                    </SlideInFromLeft>
                </div>
                ...
                <SlideInFromRight>
                    <div className='2xl:pl-20 xl:pl-20 lg:pl-20 flex flex-col justify-between 2xl:gap-20 xl:gap-10 lg:gap-10 md:gap-20 gap-20 2xl:text-[21px] xl:text-[15px] lg:text-[16px] md:text-[27px] text-[17px]'>
                        ...
                        <div className='w-full pb-10 ' >
                            ...
                            <div className='text-primary1 flex-wrap 2xl:px-0 xl:px-0 lg:px-0 md:px-0 px-4 flex justify-center gap-6'>
